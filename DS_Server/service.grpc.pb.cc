...
::grpc::Status DBInterface::Stub::GetNextEntry(::grpc::ClientContext* context, const ::GetNextEntryRequest& request, ::GetNextEntryRequest* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetNextEntry_, context, request, response);
}

void DBInterface::Stub::experimental_async::GetNextEntry(::grpc::ClientContext* context, const ::GetNextEntryRequest* request, ::GetNextEntryRequest* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetNextEntry_, context, request, response, std::move(f));
}

void DBInterface::Stub::experimental_async::GetNextEntry(::grpc::ClientContext* context, const ::GetNextEntryRequest* request, ::GetNextEntryRequest* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::GetNextEntryRequest>* DBInterface::Stub::PrepareAsyncGetNextEntryRaw(::grpc::ClientContext* context, const ::GetNextEntryRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::GetNextEntryRequest>::Create(channel_.get(), cq, rpcmethod_GetNextEntry_, context, request, false);
}

::grpc::ClientAsyncResponseReader< ::GetNextEntryRequest>* DBInterface::Stub::AsyncGetNextEntryRaw(::grpc::ClientContext* context, const ::GetNextEntryRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status DBInterface::Stub::GetPrevEntry(::grpc::ClientContext* context, const ::GetPrevEntryRequest& request, ::GetPrevEntryRequest* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetPrevEntry_, context, request, response);
}

void DBInterface::Stub::experimental_async::GetPrevEntry(::grpc::ClientContext* context, const ::GetPrevEntryRequest* request, ::GetPrevEntryRequest* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetPrevEntry_, context, request, response, std::move(f));
}

void DBInterface::Stub::experimental_async::GetPrevEntry(::grpc::ClientContext* context, const ::GetPrevEntryRequest* request, ::GetPrevEntryRequest* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::GetPrevEntryRequest>* DBInterface::Stub::PrepareAsyncGetPrevEntryRaw(::grpc::ClientContext* context, const ::GetPrevEntryRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::GetPrevEntryRequest>::Create(channel_.get(), cq, rpcmethod_GetPrevEntry_, context, request, false);
}

::grpc::ClientAsyncResponseReader< ::GetPrevEntryRequest>* DBInterface::Stub::AsyncGetPrevEntryRaw(::grpc::ClientContext* context, const ::GetPrevEntryRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
DBInterface::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< DBInterface::Service, ::GetNextEntryRequest, ::GetNextEntryRequest>(
          [](DBInterface::Service* service,
             ::grpc::ServerContext* ctx,
             const ::GetNextEntryRequest* req,
             ::GetNextEntryRequest* resp) {
               return service->GetNextEntry(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      DBInterface_method_names[6],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< DBInterface::Service, ::GetPrevEntryRequest, ::GetPrevEntryRequest>(
          [](DBInterface::Service* service,
             ::grpc::ServerContext* ctx,
             const ::GetPrevEntryRequest* req,
             ::GetPrevEntryRequest* resp) {
...
::grpc::Status DBInterface::Service::GetNextEntry(::grpc::ServerContext* context, const ::GetNextEntryRequest* request, ::GetNextEntryRequest* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status DBInterface::Service::GetPrevEntry(::grpc::ServerContext* context, const ::GetPrevEntryRequest* request, ::GetPrevEntryRequest* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
